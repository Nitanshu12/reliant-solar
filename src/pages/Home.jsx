        ...
        <div className="about-container">
          ...
          <div className="about-content">
            ...
            <p className="about-desc">
              Founded in 2023, Reliant Renewables has been at the forefront of solar energy innovation, helping homeowners and businesses transition to clean, renewable power sources.
            </p>
            <p className="about-desc">
